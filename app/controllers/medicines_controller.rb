class MedicinesController < ApplicationController
  ...
  # GET /medicines.json
  def index
    @medicines = Medicine.all.order('disease ASC').paginate(:page => params[:page], :per_page => 10)
  end
  ...
  def update
    respond_to do |format|
      if @medicine.update(medicine_params)
        format.html { redirect_to @medicine, notice: 'The medicine list was successfully updated.' }
  ...
  def destroy
    @medicine.destroy
    respond_to do |format|
      format.html { redirect_to medicines_url, notice: 'Deleted.' }
  ...
  private
    ...
    def medicine_params
      params.require(:medicine).permit(:disease, :med, :note)
    end
end
