...
class FuelsControllerTest < ActionController::TestCase
  ...
  test "should create fuel" do
    assert_difference('Fuel.count') do
      post :create, fuel: { date: @fuel.date, location: @fuel.location, supply: @fuel.supply, time: @fuel.time }
    end
  ...
  test "should update fuel" do
    patch :update, id: @fuel, fuel: { date: @fuel.date, location: @fuel.location, supply: @fuel.supply, time: @fuel.time }
    assert_redirected_to fuel_path(assigns(:fuel))
  end
