...
class SuppliesControllerTest < ActionController::TestCase
  ...
  test "should create supply" do
    assert_difference('Supply.count') do
      post :create, supply: { contact: @supply.contact, info: @supply.info, location: @supply.location, requirement: @supply.requirement }
    end
  ...
  test "should update supply" do
    patch :update, id: @supply, supply: { contact: @supply.contact, info: @supply.info, location: @supply.location, requirement: @supply.requirement }
    assert_redirected_to supply_path(assigns(:supply))
  end
